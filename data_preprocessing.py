...
word_tags_list = [] #list of the pair of (['words', 'of', 'the', 'sentence'], 'tags')
...
def create_bot_corpus(words, classes, word_tags_list, ignore_words):
    ...
    return stem_words, classes, word_tags_list
...
def bag_of_words_encoding(stem_words, word_tags_list):
    ...
    for word_tags in word_tags_list:
        ...
        for i in pattern_words:
          index=pattern_words.index(i)
          i=stemmer.stem(i.lower())
          pattern_words[index]=i
        for i in stem_words:
          if i in pattern_words:
    ...
    return np.array(bag)
def class_label_encoding(classes, word_tags_list):
...
def preprocess_train_data():
    ...
    stem_words, tag_classes, word_tags_list = create_bot_corpus(words, classes, word_tags_list, ignore_words)
